...
const int FREQ = 3; //must be >2 or breathing at top of water breaks
...
void onTick(CBlob@ this)
{
	...
	if (getNet().isServer())
	{
		...
		if(this.hasTag("space_suit")){
			hasAir = true;
			this.set_u16("air_tank",this.get_u16("air_tank")-3);
		...
		if (!hasAir)
		{
			...
			if (aircount < FREQ)
			{
				this.server_Hit(this, pos, Vec2f(0, 0), 10.0f, Hitters::drown, true);
