...
namespace Material
{
  ...
  void fromTile(CBlob@ this, uint16 &in type, float &in damage)
  {
    ...
    {
      //createFor(this, 'mat_scrap', 3 * damage);
    }
    else if (map.isTileStone(type))
    {
      //createFor(this, 'mat_scrap', 2 * damage);
    }
    else if (map.isTileCastle(type))
    {
      //createFor(this, 'mat_scrap', 1 * damage);
    }
    else if (map.isTileWood(type))
    {
      //createFor(this, 'mat_scrap', damage);
    }
    else if (map.isTileGold(type))
    {
      //createFor(this, 'mat_scrap', 4 * damage);
    }
  }
}
