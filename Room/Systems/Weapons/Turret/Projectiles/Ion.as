...
{
	if(blob !is null)if(blob.getName() == "pilots_seat")return;
...
void onDie(CBlob@ this)
{
	...
	for (u32 k = 0; k < blobs.length; k++)
	{
		...
		if(blob.hasTag("room")){
			...
			blob.set_u16("IonTime",blob.get_u16("IonTime")+5*amount*30);
			blob.set_u16("IonDamage",blob.get_u16("IonDamage")+amount*30);
		}
